...
All below listed packages (expect this minor-mode) can be installed via "MELPA":http://melpa.milkbox.net, "ELPA":http://tromey.com or "MARMELADE":http://marmalade-repo.org.
