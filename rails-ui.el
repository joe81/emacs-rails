...
(defconst rails-minor-mode-nav-menu-bar-map
  (let ((map (make-sparse-keymap)))
    (define-keys map
      ...
      ([goto-models-tests] '("Go to Models Tests"      . rails-nav:goto-models-tests))
      ([goto-libs]         '("Go to Libs"              . rails-nav:goto-libs))
      ([goto-decorators]   '("Go to Decorators"        . rails-nav:goto-decorators))
      ([goto-mailers]      '("Go to Mailers"           . rails-nav:goto-mailers))
...
(defconst rails-minor-mode-tests-menu-bar-map
  (let ((map (make-sparse-keymap)))
    (define-keys map
      ...
      ([models]       '("Models Tests"        . rails-test:run-models))
      ([controllers]  '("Controllers Tests"   . rails-test:run-controllers))
      ([decorators]   '("Decorators Tests"    . rails-test:run-decorators))
...
(define-keys rails-minor-mode-map
  ...
  ((rails-key "\C-c g d") 'rails-nav:goto-decorators)
  ...
  ((rails-key "\C-c g f") 'rails-nav:goto-controllers-tests)
  ...
  ((rails-key "\C-c y u") 'rails-test:run-models)
  ((rails-key "\C-c y f") 'rails-test:run-controllers)
